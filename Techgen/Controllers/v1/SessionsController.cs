...
namespace Techgen.Controllers.v1.Admin
{
    ...
    public class SessionsController : _BaseApiController
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestModel model)
        {
            ...
            return Created(new JsonResponse<IBaseResponse<LoginResponseModel>>(response));
        }
        ...
        {
            return Created(new JsonResponse<IBaseResponse<TokenResponseModel>>(await _accountService.RefreshTokenAsync(model.RefreshToken, new List<string> { Role.User })));
        }
    }
}
